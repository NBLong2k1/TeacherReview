...
<html>
    ...
    <body>
        ...
        <div class="container">  
            <form id="contact" action="newteacherinfo" method="Post">
                <h3>${title}</h3><br>
                <c:if test="${t!=null}">
                ...
                <fieldset>
                    <input style="width: 25em;  height: 5em; margin-left: 5px; " name="submit" type="submit" id="contact-submit" data-submit="...Sending" value="Submit">
                </fieldset>
            </form>
